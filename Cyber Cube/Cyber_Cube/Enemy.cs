...
namespace Cyber_Cube {
	class Enemy : DrawableGameComponent {
		...
		private Cyber_Cube.IO.Action[] movementPatterns = new[] { 
			IO.Action.MoveDown, IO.Action.MoveDown, IO.Action.MoveDown, IO.Action.MoveDown, 
			IO.Action.MoveLeft, IO.Action.MoveLeft, IO.Action.MoveLeft, IO.Action.MoveLeft, 
			IO.Action.MoveUp, IO.Action.MoveUp, IO.Action.MoveUp, IO.Action.MoveUp, 
			IO.Action.MoveRight, IO.Action.MoveRight, IO.Action.MoveRight, IO.Action.MoveRight };
		...
		public override void Update(GameTime gameTime) {
			...
			switch (movementPatterns[movementIndex]) {
				case IO.Action.MoveRight:
					delta2d.X += 1.0f;
					break;
				case IO.Action.MoveLeft:
					delta2d.X -= 1.0f;
					break;
				case IO.Action.MoveUp:
					delta2d.Y += 1.0f;
					break;
				case IO.Action.MoveDown:
					delta2d.Y -= 1.0f;
					break;
			}
